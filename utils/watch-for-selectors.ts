...
export function watchForSelectors(
  ...
  if (!callback || typeof callback !== "function") throw new Error("watchForSelectors: Callback must be a function")
  if (typeof options !== "object") throw new Error("watchForSelectors: Options must be an object")
